...
class Oppgaver extends Spec with ShouldMatchers {
  ...
  describe("Oppgaver - ") {
    ...
    describe("oppgave 6 - traignores") {
      ...
      ignore("Lag en geignoreekilling som sier 'meee'") {

        // Hint: her må man lage en egen BukkSomKilling-klasse og bruke "stackable"-traignoreet Killing
        val killing = new Bukk("bignoreteLille", "XS")
